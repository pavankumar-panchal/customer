...
session_start();
	...
	else
	{
		...
		if($cusid == 17)
			...
			$customerid = $username;
		$query = "SELECT *,AES_DECRYPT(loginpassword,'imaxpasswordkey') as loginpassword FROM inv_mas_customer WHERE slno = '".$customerid."'";
		...
		else
		{
			...
			else
			{
				...
				else
				{
					...
					$query1 ="INSERT INTO inv_logs_login (userid,`date`,`time`,`type`,system,device,browser) VALUES('".$user."','".date('Y-m-d')."','".date('h:i:s')."','customer_login','".$_SERVER['REMOTE_ADDR']."','DESKTOP','".$_SERVER['HTTP_USER_AGENT']."')";
...
<table width="900px" border="0" align="center" cellpadding="0" cellspacing="0" >
          ...
          <tr>
            <td align="center"><form id="submitform" name="submitform" method="post" action="" onsubmit="return false">
                ...
                <tr><td height:"18px"></td></tr>
                  ...
                  <tr>
                    <td colspan="2" align="left" valign="top"><font color="#CCCCCC">[Eg: <font color="#FF9933">1234-4356-7891-12345</font> OR <font color="#FF9933">12344356789112345</font> OR <font color="#FF9933">12345</font>]</font></td>
                    </tr>
                  <tr>
  ...
  &nbsp;&nbsp;&nbsp;
                      <input name="clear" class="custchoicebutton-orange" type="reset"  id="clear" value="Clear" onClick="document.getElementById('form-error').innerHTML = ''; " />
                    </div></td>
                  </tr>
  ...
  <tr>
    ...
    <td colspan="2" style="padding-left:40px ;color:#5959FF">
       1.&nbsp;<a href="retrival/password.php" class="passwd-font">Retrieve Your Password</a>    </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td colspan="2" style="padding-left:40px ;color:#5959FF">
      2.&nbsp;<a href="retrival/customer.php" class="passwd-font">Retrieve Your Customer ID</a>  </tr>
</table>  </td>
                    </tr>
                    <tr>
                      <td colspan="2">&nbsp;</td>
