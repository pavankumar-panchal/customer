...
{ 
	...
	$onlineinvoicenopost = $_POST['onlineslno']; 
	
	//echo($onlineinvoiceno);exit;
	// Fetch all Details 
	
	$query1 = "select * from dealer_online_purchase where slno = '".$onlineinvoicenopost."';";
	...
	$paymentamount = $fetch1['netamount'];
	$company = $fetch1['businessname'];
	...
	$query11 = "UPDATE dealer_online_purchase SET  paymentdate = '".date('Y-m-d')."', paymenttime = '".date('H:i:s')."',paymenttypeselected = 'paymentmadenow', paymentmode = 'creditordebit',onlineinvoiceno = '".$onlineinvoiceslno."'  WHERE slno = '".$onlineinvoicenopost."'";
	...
	//$bccarray = array('Bigmail' => 'bigmail@relyonsoft.com', 'Accounts'=> 'bills@relyonsoft.com');
	...
	echo('Done'.$onlineinvoiceslno);exit;
