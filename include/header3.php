...
<table width="100%" border="0" cellspacing="0" cellpadding="0"  >
        <tr>
          ...
          <td width="76%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td style="border:1px solid #932f18; background-color:#FFFFFF"><table width="98%" border="0" align="center" cellpadding="2" cellspacing="0">
                <tr>
                  <td colspan="2" height="10"></td>
                </tr>
                <tr >
                  <td width="53%" ><a href="../index.php" class="Linking"><strong>Home</strong></a>&nbsp;|&nbsp;&nbsp;<font color="#666666">Profile</font>&nbsp;| &nbsp;&nbsp;<font color="#666666">Messages</font></td>
                  <td width="47%" ><div align="right"><font color="#666666">Logout</font></div></td>
                </tr>
                <tr>
