...
$tdsparray = array('942','634','708','744','635','638','639','641','642','643','644','667','669');
$tdscarray = array('954','963','951','961','955','965','964','956','636','715','752','645','647','650','652','656','658','660','662','665');
$tdsiarray = array('960','966','637','720','760','646','648','651','653','657','659','661','664','668');

//dot products
$tdsdparray = array('711');
$tdsdcarray = array('709');
$tdsdiarray = array('710');
//dot products ends 

$tdsplarray = array('690','691','692','693');
$stoarray = array('346','349','345','321','348','384','366','330','350','351','352','353','354','355','356');
$sitarray = array('303','304','305','306','307','308','309','310','311');
$saiarray = array('210','211','212','213','216','215','219','222');
$svharray = array('471','469','472','473','475','482','478','483','484','485','486','487');
...
'889','890','891','893','894','895','899','900','902','903','904','905');
$sesarray = array('101');
$scommuarray = array('160');
$sxbrlarray = array('239','240','242','244','241','243','245','246','247','252','253');
$sst3array = array('369','370','371','372','373','374');
$sbiarray = array('214','217','220','223');
$saiparray = array('215');
$sairarray = array('583');

$sfintracproarray = array('585');
$sfintracprearray = array('586');
...
<td><table width="100%" border="0" cellspacing="0" cellpadding="6">
<tr bgcolor="#f7faff">
<td colspan="3" valign="top" bgcolor="#F7FAFF"  ><div class="product-font" id="tabh30" onclick="tabopen14('30','tab');"><font color="#0000CC"><strong>Saral FinTrac - Professional</strong></font></div>
<div id="tabc30" style="display:block; padding:5px "><!--FinTrac  Professional-->
<table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td width="61%"><table width="100%"  border="0" cellpadding="5" cellspacing="0">
                    <tr bgcolor="#edf4ff" >
                      ...
                      <td width="70%" valign="top" bgcolor="#EDF4FF" class="product_content"><strong><font color="#FF0000">11.00</font></strong></td>
                    </tr>
                    <tr bgcolor="#f7faff">
                    ...
                    <tr bgcolor="#f7faff">
                      ...
                      <td valign="top" bgcolor="#EDF4FF" class="product_content">Versions above 10.00</td>
                    </tr>
                    <tr bgcolor="#f7faff">
                      <td valign="top" bgcolor="#f7faff" class="product_content">Size</td>
                      <td valign="top" bgcolor="#f7faff" class="product_content">135000 KB</td>
                    </tr>
                  </table></td>
                <td width="39%" valign="top" bgcolor="#EDF4FF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                      <td><div align="center"><a href="http://www.etds-payroll-salary-software-india.com/downloads/saralpaypack/SaralPayPack_v10p0_To_11p0.exe"><img src="../images/imax-customer-downloadicon.gif" alt="Download"  title="Download" border="0" /></a></div></td>
                    </tr>
                  </table></td>
              </tr>
            </table></td>
...
</div><!--END Saral  PayPack - Professional / Standard / Premium--></td>
</tr>
</table></td>
</tr>
</table></td>
