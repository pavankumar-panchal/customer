...
function implemenationstatus(lastslno)
{
	...
	ajaxcall4 = $.ajax(
	{
		...
		{	
			...
			if(response['errorcode'] == '1')
			{
				if(response['branchapproval'] == 'no' && response['coordinatorreject'] == 'no' && response['coordinatorapproval'] == 'no' && response['implementationstatus'] == 'pending' && response['branchreject'] == 'no')
				{
				...
				else if(response['branchapproval'] == 'no'  && response['branchreject'] == 'yes' && response['implementationstatus'] == 'pending')
				{
