                                      ...
                                      <td id="displaydetails"><table width="100%" border="0" cellspacing="0" cellpadding="5" >
                                          <tr>
                                            <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" >
                                                ...
                                                <tr><td><div  class="imp_dashboard_module" style="height:180px"><table width="100%" border="0" cellspacing="0" cellpadding="3" >
                                                        <tr>
                                                          <td id="implementationstatus" style="color:#FF0000; font-weight:bold; text-align:left" align="left">&nbsp;</td>
                                                        </tr>
                                                        <tr >
                                                          <td style="text-align:left"><strong>Remarks</strong> : <span id="implementationremarks"></span></td>
                                                        </tr>
                                                        <tr >
                                            ...
                                            <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" >
                                                <tr>
                                                  <td valign="top"><div class="imp_title_bar"  >
                                                   ...
                                                   <tr><td> <div class="imp_dashboard_module" >
                                          ...
                                          <tr>
                                            <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" >
                                                <tr>
                                                  <td valign="top"><div class="imp_title_bar"  >
                                                      <div class="imp_rounder"></div>
                                                      <span>Shipment Information </span></div></td></tr>
                                                   <tr><td> <div class="imp_dashboard_module" style="height:150px">
                                                      <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                                        <tr>
    ...
    <td align="center"><strong>Not Applicable</strong></td>
                                            ...
                                            <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" >
                                                <tr>
                                                  <td valign="top"><div class="imp_title_bar"  >
                                                      <div class="imp_rounder"></div>
                                                      <span>Status of Visits </span></div></td></tr>
                                                 <tr><td>   <div class="imp_dashboard_module" >
                                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                          ...
                                          <tr>
                                            <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" >
                                                <tr>
                                                  <td valign="top"><div class="imp_title_bar"  >
                                                      <div class="imp_rounder"></div>
                                                      <span>Additional Information </span></div></td></tr>
                                                    <tr><td><div class="imp_dashboard_module" style="height:150px">
                                                      <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                                        <tr>
                                            ...
                                            <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" >
                                                <tr>
                                                  <td><div class="imp_title_bar"  >
                                                      <div class="imp_rounder" ></div>
                                                      <span>Requriment Analysis</span></div></td></tr>
                                                    <tr><td><div class="imp_dashboard_module" style="height:150px">
                                                      <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                                        <tr>
                                          ...
                                          <tr>
                                            <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" >
                                                <tr>
                                                  <td valign="top"><div class="imp_title_bar"  >
                                                      <div class="imp_rounder"></div>
                                                      <span>Add-on Module </span></div></td></tr>
                                                    <tr><td><div class="imp_dashboard_module" style="height:150px">
                                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                            ...
                                            <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" >
                                                <tr>
                                                  <td valign="top"><div class="imp_title_bar"  >
                                                      <div class="imp_rounder"></div>
                                                      <span>Customization Information </span></div></td></tr>
                                                    <tr><td><div class="imp_dashboard_module" >
                                                      <table width="100%" border="0" cellspacing="0" cellpadding="3">
                                                        <tr>
                                          ...
                                          <tr>
                                            <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" >
                                                <tr>
                                                  <td valign="top"><div class="imp_title_bar"  >
                                                      <div class="imp_rounder"></div>
                                                      <span>Web Implementation</span></div></td></tr>
                                                    <tr><td><div class="imp_dashboard_module" style="height:150px">
                                                      <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                                        <tr>
    ...
    <td align="center"><strong>Not Applicable</strong></td>
                                            ...
                                            <td width="50%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" >
                                                <tr>
                                                  <td><div class="imp_title_bar"  >
                                                      <div class="imp_rounder" ></div>
                                                      <span>Attendance Integration</span></div></td></tr>
                                                    <tr><td><div class="imp_dashboard_module" style="height:150px">
                                                      <table width="100%" border="0" cellspacing="0" cellpadding="5">
                                                        <tr>
