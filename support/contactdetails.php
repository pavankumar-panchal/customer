...
<title>Support | Relyon Customer Login Area</title>
          ...
          <td width="700" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td class="content-mid"><table width="100%" border="0" cellspacing="0" cellpadding="5">
                    <tr>
                      <td class="subheadind-font">Contact by Phone</td>
                    </tr>
                    <tr>
                      <td class="blueline" height="4px"></td>
                    </tr>
                    <tr>
                      <td><img src="../images/imax-support-phone-landing-diagram-20140912.jpg" border="0" alt="imax-support-phone-landing-diagram" title="imax-support-phone-landing-diagram" /></td>
                    </tr>
                </table></td>
              </tr>
              <tr>
